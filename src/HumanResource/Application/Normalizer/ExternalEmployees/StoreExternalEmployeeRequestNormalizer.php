...
class StoreExternalEmployeeRequestNormalizer
{
    public function normalize(StoreExternalEmployeeRequest $request): StoreExternalEmployeeDto
    {
        return new StoreExternalEmployeeDto(
