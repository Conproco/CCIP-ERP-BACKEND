...
/**
 * Normaliza el request de actualización de empleado a un DTO.
 */
class UpdateEmployeeRequestNormalizer
{
    public function normalize(UpdateManagementEmployees $request, int $employeeId): UpdateEmployeeDto
    {
