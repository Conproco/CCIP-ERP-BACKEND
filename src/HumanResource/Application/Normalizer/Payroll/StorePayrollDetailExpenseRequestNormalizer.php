...
use Carbon\Carbon;
use Src\HumanResource\Application\Dto\Payroll\StorePayrollDetailExpenseDto;

class StorePayrollDetailExpenseRequestNormalizer
{
    public function normalize(StorePayrollDetailExpenseRequest $request): StorePayrollDetailExpenseDto
    {
        return new StorePayrollDetailExpenseDto(
